#!/usr/bin/env python3
"""Count symbol_fac566ad_count2.png in H.pdf"""
import sys
sys.path.insert(0, '.')
...
pdf_path = "H.pdf"
symbol_path = "outputs/vector_symbols/symbol_fac566ad_count2.png"

print("="*70)
print("COUNTING SYMBOL: symbol_fac566ad_count2.png")
print("="*70)
...
if results:
    ...
    for page_result in results['pages']:
        ...
        if page_result['detections']:
            ...
            print(f"    Detections: {len(page_result['detections'])}")
    
    # Save results
    output_file = Path("outputs") / "symbol_count_fac566ad.json"
